...
import { lessonAndPageIdAtom, safeCurrentIndicesAtom } from "../lib/learn-atoms"
...
export default function CodeTabs() {
    ...
    let files = Object.keys(page.fileContents).filter((file) => !file.endsWith("_hidden.baml"))

    return (
        <Tabs
         defaultValue={lessonAndPageId.tabId}
         value={lessonAndPageId.tabId}
         >
            <TabsList>
