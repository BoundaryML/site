...
import { currentCodeBlock, runtimeAtom, diagnosticsAtom, CodeMirrorDiagnosticsAtom, lessonsAtom, visibleFileAtom, safeCurrentIndicesAtom } from '../lib/learn-atoms'
...
export const CodeEditor = () => {
    ...
    const { lessonIndex, pageIndex, tabId, lesson, page } = useAtomValue(safeCurrentIndicesAtom)
